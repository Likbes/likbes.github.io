! function (e) {
  ...
  (function (e) {
    var r = n(0),
      ...
      a = n(15),
      o = n.n(a);
    t.a = Object(i.hot)(e)(class extends l.a.Component {
      render() {
        const {
          text: e,
          handleClick: t
  ...
  */
  ...
  function A(e, t, n, r, l) {
    var i = "";
    null != n && (i = ("" + n).replace(M, "$&/") + "/"), D(e, L, t = z(t, i, r, l)), I(t)
  }
    ...
    t.a = Object(i.hot)(e)(class extends l.a.Component {
      constructor(e) {
        super(e), this.state = {
          data: [],
          copy: []
        }, this.loadTrendingGIF = this.loadTrendingGIF.bind(this), this.selectOneRandom = this.selectOneRandom.bind(this), this.randomizeOrder = this.randomizeOrder.bind(this), this.reverseOrder = this.reverseOrder.bind(this), this.clearAll = this.clearAll.bind(this)
      }
      loadTrendingGIF(e) {
        e.preventDefault(), fetch("https://api.giphy.com/v1/gifs/trending?api_key=yMcWHbNz3IByrlaS1RBcYNw1XmARTUWL").then(e => e.json()).then(e => {
          const t = e.data.reduce((e, t) => [...e, t.images.fixed_height.url], []);
          this.setState({
            data: t,
            copy: t
          })
      ...
      selectOneRandom(e) {
        e.preventDefault(), "" != this.state.data && this.setState({
          copy: [this.state.data[this.randomMinMax(0, 24)]]
        })
      }
      randomizeOrder(e) {
        e.preventDefault(), "" != this.state.data && this.setState(e => ({
          copy: e.data.sort(() => Math.random() - .5)
        }))
      }
      reverseOrder(e) {
        e.preventDefault(), "" != this.state.data && this.setState(e => ({
      ...
      render() {
        ...
        return l.a.createElement(l.a.Fragment, null, l.a.createElement("h1", null, "Trending GIFs courtesy of the", l.a.createElement("a", {
          href: "https://github.com/Giphy/GiphyAPI"
        }, " Giphy API")), l.a.createElement(a.a, {
          ...
          handleClick: this.randomizeOrder
        }), l.a.createElement(a.a, {
          text: "Reverse Order",
          handleClick: this.reverseOrder
        }), l.a.createElement(a.a, {
          text: "Clear All",
          handleClick: this.clearAll
        }), l.a.createElement("div", {
          id: "container"
        }, e.map(e => l.a.createElement("img", {
          src: e,
          alt: "gif",
          key: e
        }))))
  ...
  var r = n(0),
    ...
    a = n.n(i),
    o = n(7);
  a.a.render(l.a.createElement(o.a, null), document.getElementById("root"))
}, function (e, t, n) {
  "use strict";
  /** @license React v16.8.3
  ...
  var At = {
      ...
      extractEvents: function (e, t, n, r) {
        ...
        if ("select" === o || "input" === o && "file" === l.type ? i = Mt : Le(l) ? Rt ? i = Lt : (i = Ut, a = Dt) : (o = l.nodeName) && "input" === o.toLowerCase() && ("checkbox" === l.type || "radio" === l.type) && (i = Ft), i && (i = i(e, t))) return Et(i, n, r);
    ...
    Xt = {
      ...
      extractEvents: function (e, t, n, r) {
        ...
        var a = void 0,
          ...
          u = void 0,
          c = void 0;
        "mouseout" === e || "mouseover" === e ? (a = Kt, o = Gt.mouseLeave, u = Gt.mouseEnter, c = "mouse") : "pointerout" !== e && "pointerover" !== e || (a = Yt, o = Gt.pointerLeave, u = Gt.pointerEnter, c = "pointer");
        var s = null == i ? l : F(i);
  ...
  function Ln(e) {
    ...
    if (t !== n && n && n.ownerDocument && function e(t, n) {
      ...
      if (null !== r && Fn(n))
        ...
        r = void 0 === r.end ? i : Math.min(r.end, l), !e.extend && i > r && (l = r, r = i, i = l), l = Dn(n, i);
        var a = Dn(n, r);
  ...
  N.injectEventPluginOrder("ResponderEventPlugin SimpleEventPlugin EnterLeaveEventPlugin ChangeEventPlugin SelectEventPlugin BeforeInputEventPlugin".split(" ")), x = L, w = U, T = F, N.injectEventPluginsByName({
  ...
  function Kr(e, t, n, r, l, i) {
    ...
    if (r = e, "function" == typeof e) Qr(e) && (o = 1);
      ...
      case Ge:
        return Gr(n, 2 | l, i, t);
      case Xe:
        return (e = $r(12, n, t, 4 | l)).elementType = Xe, e.type = Xe, e.expirationTime = i, e;
      case nt:
  ...
  var al = {
    ...
    enqueueSetState: function (e, t, n) {
      ...
      var r = wo(),
        l = Yi(r = Ka(r, e));
      l.payload = t, null != n && (l.callback = n), Va(), Xi(e, l), Xa(e, r)
    },
    enqueueReplaceState: function (e, t, n) {
      e = e._reactInternalFiber;
      var r = wo(),
        l = Yi(r = Ka(r, e));
      l.tag = Bi, l.payload = t, null != n && (l.callback = n), Va(), Xi(e, l), Xa(e, r)
    },
    enqueueForceUpdate: function (e, t) {
      e = e._reactInternalFiber;
      var n = wo(),
        r = Yi(n = Ka(n, e));
      r.tag = Hi, null != t && (r.callback = t), Va(), Xi(e, r), Xa(e, n)
    }
  };
  ...
  function ml(e) {
    ...
    function u(e, t, n, r) {
      return null === t || 6 !== t.tag ? ((t = Xr(n, e.mode, r)).return = e, t) : ((t = l(t, n)).return = e, t)
    }
    ...
    return function (e, r, i, u) {
      ...
      if ("string" == typeof i || "number" == typeof i) return i = "" + i, null !== r && 6 === r.tag ? (n(e, r.sibling), (r = l(r, i)).return = e, e = r) : (n(e, r), (r = Xr(i, e.mode, u)).return = e, e = r), o(e);
  ...
  function Gl(e, t, n, r, l, i) {
    if (Dl = i, Ul = t, Ll = null !== e ? e.memoizedState : null, Il.current = null === Ll ? ci : si, t = n(r, l), $l) {
      do {
        $l = !1, ql += 1, Ll = null !== e ? e.memoizedState : null, Wl = Al, Bl = jl = Fl = null, Il.current = si, t = n(r, l)
      } while ($l);
      Ql = null, ql = 0
    }
    return Il.current = ui, (e = Ul).memoizedState = Al, e.expirationTime = Vl, e.updateQueue = Bl, e.effectTag |= Hl, e = null !== Fl && null !== Fl.next, Dl = 0, Wl = jl = Al = Ll = Fl = Ul = null, Vl = 0, Bl = null, Hl = 0, e && a("300"), t
  }

  function Xl() {
    Il.current = ui, Dl = 0, Wl = jl = Al = Ll = Fl = Ul = null, Vl = 0, Bl = null, Hl = 0, $l = !1, Ql = null, ql = 0
  }
  ...
  function ti(e) {
    ...
    if (i = t.baseState, null !== o ? (null !== r && (r.next = null), r = o.next) : r = null !== r ? r.next : null, null !== r) {
      ...
      do {
        ...
        f < Dl ? (s || (s = !0, u = o, l = i), f > Vl && (Vl = f)) : i = c.eagerReducer === e ? c.eagerState : e(i, c.action), o = c, c = c.next
      } while (null !== c && c !== r);
    ...
    ci = {
      ...
      useReducer: function (e, t, n) {
        ...
        return t = void 0 !== n ? n(t) : t, r.memoizedState = r.baseState = t, e = (e = r.queue = {
          ...
          eagerReducer: e,
          eagerState: t
        }).dispatch = oi.bind(null, Ul, e), [r.memoizedState, e]
      },
      useRef: function (e) {
        return e = {
          current: e
      ...
      useState: function (e) {
        ...
        return "function" == typeof e && (e = e()), t.memoizedState = t.baseState = e, e = (e = t.queue = {
          ...
          eagerReducer: ei,
          eagerState: e
        }).dispatch = oi.bind(null, Ul, e), [t.memoizedState, e]
      },
      useDebugValue: ai
    },
    si = {
  ...
  function Ti(e, t, n, r, l) {
    n = n.render;
    var i = t.ref;
    return ji(t, l), r = Gl(e, t, n, r, i, l), null === e || xi ? (t.effectTag |= 1, wi(e, t, r, l), t.child) : (t.updateQueue = e.updateQueue, t.effectTag &= -517, e.expirationTime <= l && (e.expirationTime = 0), Ri(e, t, l))
  }
  ...
  function Ci(e, t, n, r, l) {
    ...
    return i = zr(t, i), ji(t, l), n = Gl(e, t, n, r, i, l), null === e || xi ? (t.effectTag |= 1, wi(e, t, n, l), t.child) : (t.updateQueue = e.updateQueue, t.effectTag &= -517, e.expirationTime <= l && (e.expirationTime = 0), Ri(e, t, l))
  }
  ...
  function zi(e, t, n) {
    ...
    switch (t.expirationTime = 0, t.tag) {
      case 2:
        ...
        if (ji(t, n), l = Gl(null, t, r, e, l, n), t.effectTag |= 1, "object" == typeof l && null !== l && "function" == typeof l.render && void 0 === l.$$typeof) {
          if (t.tag = 1, Xl(), Ir(r)) {
            var i = !0;
            Ar(t)
          } else i = !1;
                ...
                if (null !== c) {
                  ...
                  for (var s = c.first; null !== s;) {
                    if (s.context === r && 0 != (s.observedBits & i)) {
                      1 === u.tag && ((s = Yi(n)).tag = Hi, Xi(u, s)), u.expirationTime < n && (u.expirationTime = n), null !== (s = u.alternate) && s.expirationTime < n && (s.expirationTime = n), s = n;
  ...
  function Xi(e, t) {
    ...
    null === l || r === l ? Gi(r, t) : null === r.lastUpdate || null === l.lastUpdate ? (Gi(r, t), Gi(l, t)) : (Gi(r, t), l.lastUpdate = t)
  }

  function Zi(e, t) {
    var n = e.updateQueue;
    null === (n = null === n ? e.updateQueue = qi(e.memoizedState) : Ji(e, n)).lastCapturedUpdate ? n.firstCapturedUpdate = n.lastCapturedUpdate = t : (n.lastCapturedUpdate.next = t, n.lastCapturedUpdate = t)
  }
      ...
      case 13:
        if (n = t.memoizedState, r = void 0, e = t, null === n ? r = !1 : (r = !0, e = t.child, 0 === n.timedOutAt && (n.timedOutAt = wo())), null !== e && function (e, t) {
          ...
          null === o && (o = t.stateNode = new sa), n.forEach(function (e) {
            var n = function (e, t) {
              var n = e.stateNode;
              null !== n && n.delete(t), t = Ka(t = wo(), e), null !== (e = Ga(e, t)) && (Jr(e, t), 0 !== (t = e.expirationTime) && To(e, t))
            }.bind(null, t, e);
  ...
  function wa(e) {
    switch (e.tag) {
      ...
      case 3:
        return Tl(), Ur(), 0 != (64 & (t = e.effectTag)) && a("285"), e.effectTag = -2049 & t | 64, e;
      case 5:
        return Sl(e), null;
      case 13:
        ...
        e: {
          ...
          switch (t.tag) {
            ...
            case 1:
              ...
              break;
            case 3:
              Tl(), Ur(), (u = t.stateNode).pendingContext && (u.context = u.pendingContext, u.pendingContext = null), null !== i && null !== i.child || (gi(t), t.effectTag &= -3), oa(t);
              break;
            case 5:
              Sl(t);
              var c = xl(kl.current);
                ...
                if (gi(t)) {
                  ...
                  switch (f) {
                    ...
                    case "select":
                      ...
                      break;
                    case "textarea":
                      Gn(p, d), c = Yn(p, d), Sn("invalid", p), pr(m, "onChange");
                      break;
                    default:
                      c = d
                  }
  ...
  function Qa(e, t) {
    ...
    r === Na && e === Pa && null !== Ca || (La(), Na = r, Ca = qr((Pa = e).current, null), e.pendingCommitExpirationTime = 0);
    for (var l = !1;;) {
      try {
        if (t)
        ...
        if (Fi = Ui = Di = null, Xl(), null === Ca) l = !0, Ro(t);
        else {
          null === Ca && a("271");
          var i = Ca,
            o = i.return;
                ...
                do {
                  if ((h = 13 === f.tag) && (h = void 0 !== f.memoizedProps.fallback && null === f.memoizedState), h) {
                    if (null === (c = f.updateQueue) ? ((c = new Set).add(d), f.updateQueue = c) : c.add(d), 0 == (1 & f.mode)) {
                      f.effectTag |= 64, s.effectTag &= -1957, 1 === s.tag && (null === s.alternate ? s.tag = 17 : ((o = Yi(1073741823)).tag = Hi, Xi(s, o))), s.expirationTime = 1073741823;
                      break e
                    }
                    c = o;
                    var v = (s = u).pingCache;
    ...
    if (Ea = !1, Ta.current = n, Fi = Ui = Di = null, Xl(), l) Pa = null, e.finishedWork = null;
  ...
  function qa(e, t) {
    for (var n = e.return; null !== n;) {
      switch (n.tag) {
        case 1:
          var r = n.stateNode;
          if ("function" == typeof n.type.getDerivedStateFromError || "function" == typeof r.componentDidCatch && (null === Fa || !Fa.has(r))) return Xi(n, e = xa(n, e = la(t, e), 1073741823)), void Xa(n, 1073741823);
          break;
        case 3:
          return Xi(n, e = ka(n, e = la(t, e), 1073741823)), void Xa(n, 1073741823)
      }
      n = n.return
    }
    3 === e.tag && (Xi(e, n = ka(e, n = la(t, e), 1073741823)), Xa(e, 1073741823))
  }
  ...
  function Xa(e, t) {
    null !== (e = Ga(e, t)) && (!Ea && 0 !== Na && t > Na && La(), Jr(e, t), Ea && !za && Pa === e || To(e, e.expirationTime), yo > vo && (yo = 0, a("185")))
  }
  ...
  function Uo(e, t, n, r, l) {
    ...
    return null === t.context ? t.context = n : t.pendingContext = n, t = l, (l = Yi(r)).payload = {
      element: e
    }, null !== (t = void 0 === t ? null : t) && (l.callback = t), Va(), Xi(i, l), Xa(i, r), r
  }

  function Fo(e, t, n, r) {
    var l = t.current;
    return Uo(e, t, n, l = Ka(wo(), l), r)
  }
  ...
  var $o = {
    ...
    __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: {
      Events: [U, F, L, N.injectEventPluginsByName, g, H, function (e) {
        E(e, B)
      }, Oe, Me, Pn, M]
    }
  };
    ...
    if ("undefined" != typeof window ? S = window : void 0 !== e && (S = e), S && S._schedMock) {
      ...
      var A = function (e) {
        if (null !== N) {
          k(A);
          var t = e - I + U;
          t < U && D < U ? (8 > t && (t = 8), U = t < D ? D : t) : D = t, I = e + U, O || (O = !0, L.postMessage(void 0))
        } else R = !1
      };
      w = function (e, t) {
